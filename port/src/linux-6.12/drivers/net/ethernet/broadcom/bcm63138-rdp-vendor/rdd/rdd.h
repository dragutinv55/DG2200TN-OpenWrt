...
#undef VIRT_TO_PHYS
extern uint32_t bcm63138_rdp_virt_to_dma(uint32_t address);
#define VIRT_TO_PHYS(_addr)	bcm63138_rdp_virt_to_dma((uint32_t)(_addr))
#endif
...
#include "rdd_runner_defs_stock_override.h"
...
/* Replaced #include "rdd_interworking.h" with local extern declarations to avoid undefined RDPA type issues */
extern BL_LILAC_RDD_ERROR_DTE rdd_ds_wan_flow_config(u32 wan_flow, void *cpu_reason, int flow_classify_mode, u8 ingress_flow);
#endif
